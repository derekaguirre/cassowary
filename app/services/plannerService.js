...
export const downloadData = () => {
  ...
  data["checklist"] = useChecklistStore().checklist;
...
export const uploadData = (uploadedData) => {
  ...
  if (uploadedData["checklist"] !== undefined) {
    useChecklistStore().restoreData(uploadedData["checklist"]);
    success.push("checklist");
  }
